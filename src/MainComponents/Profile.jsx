                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      disabled={!isEditing}
                      className="w-full rounded-2xl border border-slate-200 bg-[#F8FAFC] px-5 py-3.5 font-medium text-[#0F172A] placeholder-slate-400 shadow-sm transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#E8791E] focus:border-transparent focus:bg-white disabled:cursor-not-allowed disabled:opacity-70"
                    />
                  </div>
                      ...
                      >
                        <div className="space-y-2">
                          ...
                          <input
                            ...
                            onChange={handleChange}
                            disabled={!isEditing}
                            className="w-full rounded-2xl border border-slate-200 bg-white px-5 py-3.5 font-medium text-[#0F172A] placeholder-slate-400 shadow-sm transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#E8791E] focus:border-transparent disabled:cursor-not-allowed disabled:opacity-70"
              ...
              <AnimatePresence>
                {isEditing && (
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="group relative w-full rounded-2xl bg-[#0F172A] py-4 text-lg font-bold text-white shadow-xl transition-all duration-300"
                    disabled={submitted}
                  >
            ...
            <div className="mt-8 space-y-5">
              ...
              {user?.liveProject && user.liveProject.applied && (
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-[#A78BFA] to-[#8B5CF6]">
                        <span className="text-lg">🚀</span>
                      </div>
                      <div>
              ...
              {user?.softSkill && user.softSkill.applied && (
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-[#34D399] to-[#10B981]">
                        <span className="text-lg">⭐</span>
                      </div>
                      <div>
              ...
              >
                <motion.button
                  ...
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="group relative w-full overflow-hidden rounded-2xl bg-gradient-to-r from-[#EF4444] to-[#DC2626] py-4 text-lg font-bold text-white shadow-xl shadow-red-500/20"
                >
