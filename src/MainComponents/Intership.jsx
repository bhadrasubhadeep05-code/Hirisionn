          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {internshipCategories.map((category, index) => (
              ...
              >
                ...
                <button className="mt-auto w-full py-3 px-6 border-2 border-[#22D3EE] text-[#22D3EE] font-semibold rounded-lg hover:bg-[#22D3EE] hover:text-white transition-all duration-300">
                  Apply
                </button>
              </motion.div>
            ))}
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={closeModal}>
            ...
            >
              ...
              <div className="sticky top-0 bg-white border-b border-gray-200 p-6">
                ...
                <p className="text-gray-600 mt-2">Select a category to apply for internship</p>
              </div>
              ...
              <div className="p-6 space-y-4">
                {openModal.subCategories.map((subCategory, idx) => (
                  ...
                  >
                    <span className="font-medium text-[#0F172A] text-lg">{subCategory}</span>
                    <button 
                      disabled={loadingApply === idx}
                      onClick={async () => {
                        setLoadingApply(idx);
                        try {
                          await internshipUpdate({
