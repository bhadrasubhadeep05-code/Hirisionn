      ...
      <section className="relative mt-24 overflow-hidden bg-[radial-gradient(120%_160%_at_100%_0%,#1c5872,#12171B_70%)] px-6 py-16 md:py-24">
        ...
        <div className="relative z-10 mx-auto max-w-4xl">
          ...
          <p className="mt-3 flex items-center gap-2 text-lg text-slate-300">
            ...
            <span className="text-[#F2A93C] font-semibold">{CTC}</span>
          </p>
        </div>
      </section>
...
<div>
  ...
  <div className="mt-4 rounded-2xl border border-slate-200 bg-white p-6 text-base leading-7 text-slate-700 shadow-sm md:p-8">
    {jobDescription ? (
      <div
          ...
          <div>
            <div className="sticky top-28 space-y-6">
              ...
              <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                {formLink &&(
                    <div key="formLink" className="flex items-start gap-3">
                    <div>
                      <p className="text-xs font-medium uppercase tracking-[0.08em] text-slate-400">
                        Form Link
                      </p>
                      <a
                        ...
                        className="text-sm font-semibold text-[#E8791E] hover:underline"
                      >
