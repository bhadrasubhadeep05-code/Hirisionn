...
const IndustriesUpdateVideo = () => {
  ...
  useEffect(() => {
    const fetchVideo = async () => {
      ...
      try {
        setLoading(true);
        const res = await getAllIndustryVideos(page);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-[#4A5568] max-w-2xl mx-auto">
              Explore all the latest video tutorials and insights in staffing and recruitment
            </p>
          </motion.div>
...
export default IndustriesUpdateVideo
