...
import { getAllInterviewBlogs } from "../services/blog.api";
...
const InterveiwPrepBlog = () => {
  ...
  useEffect(() => {
    const fetchBlog = async () => {
      ...
      try {
        setLoading(true);
        const res = await getAllInterviewBlogs(page);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-[#4A5568] max-w-2xl mx-auto">
              Explore all the latest interview tips and guides to boost your career
            </p>
          </motion.div>
...
export default InterveiwPrepBlog;
